...
public class MeasureOperationsProvider {
    ...
    private ca.uhn.fhir.cql.r4.provider.MeasureOperationsProvider measureOperationsProvider;
    ...
    private Bundle patientCareGap(String periodStart, String periodEnd, String subject, String topic, List<Measure> measures, List<String> status, String organization) {
        ...
        for (Measure measure : measures) {
            ...
            report = this.measureOperationsProvider.evaluateMeasure(measure.getIdElement(), periodStart, periodEnd, null, "patient", subject, null,
