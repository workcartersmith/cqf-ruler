...
public class LibraryOperationsProvider implements LibraryResolutionProvider<org.hl7.fhir.r4.model.Library> {
    ...
    public LibraryOperationsProvider(LibraryResourceProvider libraryResourceProvider,
            ...
            LibraryHelper libraryHelper, DataRequirementsProvider dataRequirementsProvider) {
    ...
    public Bundle evaluate(@IdParam IdType theId, @OperationParam(name = "patientId") String patientId,
        ...
        // if (patientId == null && contextParam != null &&
        // contextParam.equals("Patient")) {
        // throw new IllegalArgumentException("Must specify a patientId when executing
        // in Patient context.");
        // }
        ...
        // VersionedIdentifier().withId(theResource.getName())
        ...
        // IGenericClient client = ClientHelperDos.getClient(resolver.getFhirContext(),
        // terminologyEndpoint);
        ...
        // IGenericClient client = ClientHelperDos.getClient(resolver.getFhirContext(),
        // dataEndpoint);
        // RestFhirRetrieveProvider retriever = new RestFhirRetrieveProvider(new
        // SearchParameterResolver(resolver.getFhirContext()), client);
        ...
        // if (additionalData != null) {
        // BundleRetrieveProvider bundleProvider = new
        // BundleRetrieveProvider(this.registry.getSystemDao().getContext(),
        // additionalData);
        // bundleProvider.setTerminologyProvider(terminologyProvider);
        // PriorityRetrieveProvider priorityProvider = new
        // PriorityRetrieveProvider(Arrays.asList(bundleProvider, retriever));
        ...
        // } else {
        // JpaFhirRetrieveProvider retriever = new
        // JpaFhirRetrieveProvider(this.registry,
        ...
        // bundleProvider.setTerminologyProvider(terminologyProvider);
        // PriorityRetrieveProvider priorityProvider = new
        // PriorityRetrieveProvider(Lists.newArrayList(bundleProvider, retriever));
        // dataProvider = new CompositeDataProvider(resolver, priorityProvider);
        // }
        // else
        // {
        ...
        // org.cqframework.cql.cql2elm.LibrarySourceProvider bundleLibraryProvider = new
        // BundleFhirLibraryContentProvider(null,libraryBundle);
        // LibraryLoader libraryLoader =
        // this.libraryHelper.createLibraryLoader(bundleLibraryProvider);
        // LibraryResolutionProvider<Library> provider =
        // this.getLibraryResourceProvider();
        // libraryLoader.getLibraryManager().getLibrarySourceLoader().registerProvider(
        // new LibraryContentProvider<org.hl7.fhir.r4.model.Library,
        // org.hl7.fhir.r4.model.Attachment>(provider,
        // x -> x.getContent(), x -> x.getContentType(), x -> x.getData()));

        // CqlEngine engine = new CqlEngine(libraryLoader,
        // Collections.singletonMap("http://hl7.org/fhir", dataProvider),
        // terminologyProvider);
        ...
        // Pair.of(contextParam != null ? contextParam : "Unspecified", patientId ==
        // null ? "null" : patientId),
        // resolvedParameters);
        ...
        // // result.addParameter().setName("location").setValue(new
        // StringType(location));
        ...
        // } else {
        // result.addParameter().setName("value").setResource(bundler.bundle((Iterable<Resource>)
        // res));
        // }
        // } else {
        // result.addParameter().setName("value").setValue(new
        // StringType(res.toString()));
        // }
        ...
        // result.addParameter().setName("resultType").setValue(new
        // StringType(resolveType(res)));
