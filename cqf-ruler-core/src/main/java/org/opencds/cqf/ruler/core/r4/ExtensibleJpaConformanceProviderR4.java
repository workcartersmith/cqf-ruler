...
public class ExtensibleJpaConformanceProviderR4 extends JpaCapabilityStatementProvider implements ExtensibleCapabilityStatementProvider {

    private List<CapabilityStatementExtender<CapabilityStatement>> extenders;

    @Inject
    public ExtensibleJpaConformanceProviderR4(RestfulServer theRestfulServer, IFhirSystemDao<?, ?> theSystemDao,
        ...
        this.setImplementationDescription("CQF Ruler FHIR R4 Server");
