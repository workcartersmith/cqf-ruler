...
import org.opencds.cqf.ruler.common.helpers.ClientHelperDos;
import org.opencds.cqf.ruler.common.helpers.DateHelper;
import org.opencds.cqf.ruler.common.providers.LibraryResolutionProvider;
import org.opencds.cqf.ruler.common.providers.LibrarySourceProvider;
import org.opencds.cqf.ruler.common.providers.R4ApelonFhirTerminologyProvider;
import org.opencds.cqf.ruler.common.retrieve.JpaFhirRetrieveProvider;
import org.opencds.cqf.ruler.r4.helpers.FhirMeasureBundler;
...
public class LibraryOperationsProvider implements LibraryResolutionProvider<org.hl7.fhir.r4.model.Library> {
    ...
    public Bundle evaluate(@IdParam IdType theId, @OperationParam(name = "patientId") String patientId,
        ...
        if (dataEndpoint != null) {
            ...
            if (additionalData != null) {
                BundleRetrieveProvider bundleProvider = new BundleRetrieveProvider(this.registry.getSystemDao().getContext(), additionalData);
            ...
            if (additionalData != null) {
                BundleRetrieveProvider bundleProvider = new BundleRetrieveProvider(this.registry.getSystemDao().getContext(), additionalData);
                bundleProvider.setTerminologyProvider(terminologyProvider);
                PriorityRetrieveProvider priorityProvider = new PriorityRetrieveProvider(Lists.newArrayList(bundleProvider, retriever));
                dataProvider = new CompositeDataProvider(resolver, priorityProvider);
            }
            else
            {
