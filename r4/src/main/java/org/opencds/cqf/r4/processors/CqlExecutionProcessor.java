...
public class CqlExecutionProcessor {
    ...
    public CqlExecutionProcessor(LibraryResolutionProvider<org.hl7.fhir.r4.model.Library> libraryResourceProvider, DataProviderFactory dataProviderFactory, FhirContext fhirContext, TerminologyProvider localSystemTerminologyProvider) {
    ...
    //TODO: replace all evaluateInContext with this signature and make above private
